...
class Settings(QtCore.QSettings):
    ...
    * Adds functionality for OpenLP Portable. If the ``defaultFormat`` is set to ``IniFormat``, and the path to the Ini
    ...
    __default_settings__ = {
        ...
        'timecode/audio output device': '__none__',
        'timecode/midi output device': '__none__',
        'timecode/mode': 'zero',
        'timecode/fps': 30,
        ...
        'media/db hostname': '',
        'media/db database': '',
        'lrcplayer/status': PluginStatus.Inactive,
        'lrcplayer/db type': 'sqlite',
        'lrcplayer/db username': '',
        ...
        'user interface/show autoplayer': False,
        'user interface/show timecode': False,
    ...
    def init_default_shortcuts(self):
        ...
        Settings.__default_settings__.update({
            ...
            'shortcuts/listViewMediaServiceItem': [QtGui.QKeySequence(QtCore.Qt.Key.Key_Plus),
                                                   QtGui.QKeySequence(QtCore.Qt.Key.Key_Equal)],
            'shortcuts/listViewLrcplayerDeleteItem': [QtGui.QKeySequence(QtGui.QKeySequence.StandardKey.Delete)],
            'shortcuts/listViewLrcplayerPreviewItem': [QtGui.QKeySequence(QtCore.Qt.Key.Key_Return),
                                                       QtGui.QKeySequence(QtCore.Qt.Key.Key_Enter)],
            'shortcuts/listViewLrcplayerLiveItem': [QtGui.QKeySequence(QtCore.Qt.Key.Key_Shift +
                                                                       QtCore.Qt.Key.Key_Return),
                                                    QtGui.QKeySequence(QtCore.Qt.Key.Key_Shift +
                                                                       QtCore.Qt.Key.Key_Enter)],
            'shortcuts/listViewLrcplayerServiceItem': [QtGui.QKeySequence(QtCore.Qt.Key.Key_Plus),
                                                       QtGui.QKeySequence(QtCore.Qt.Key.Key_Equal)],
            ...
            'shortcuts/viewAutoplayerManagerItem': [],
            'shortcuts/viewTimecodeManagerItem': [],
