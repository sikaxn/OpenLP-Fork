...
class AudioDevicesTab(SettingsTab):
    ...
    def setup_ui(self):
        ...
        self.audio_playback_group_box = QtWidgets.QGroupBox(self.left_column)
        self.audio_playback_group_box.setObjectName('audio_playback_group_box')
        self.audio_playback_layout = QtWidgets.QVBoxLayout(self.audio_playback_group_box)
        self.audio_playback_layout.setObjectName('audio_playback_layout')
        self.audio_output_label = QtWidgets.QLabel(self.audio_playback_group_box)
        self.audio_output_label.setObjectName('audio_output_label')
        self.audio_playback_layout.addWidget(self.audio_output_label)
        self.audio_output_combo_box = QtWidgets.QComboBox(self.audio_playback_group_box)
        self.audio_output_combo_box.setObjectName('audio_output_combo_box')
        self.audio_playback_layout.addWidget(self.audio_output_combo_box)

        self.smpte_timecode_group_box = QtWidgets.QGroupBox(self.left_column)
        self.smpte_timecode_group_box.setObjectName('smpte_timecode_group_box')
        self.smpte_timecode_layout = QtWidgets.QVBoxLayout(self.smpte_timecode_group_box)
        self.smpte_timecode_layout.setObjectName('smpte_timecode_layout')
        self.timecode_output_label = QtWidgets.QLabel(self.smpte_timecode_group_box)
        self.timecode_output_label.setObjectName('timecode_output_label')
        self.smpte_timecode_layout.addWidget(self.timecode_output_label)
        self.timecode_output_combo_box = QtWidgets.QComboBox(self.smpte_timecode_group_box)
        self.timecode_output_combo_box.setObjectName('timecode_output_combo_box')
        self.smpte_timecode_layout.addWidget(self.timecode_output_combo_box)
        self.timecode_frame_rate_label = QtWidgets.QLabel(self.smpte_timecode_group_box)
        self.timecode_frame_rate_label.setObjectName('timecode_frame_rate_label')
        self.smpte_timecode_layout.addWidget(self.timecode_frame_rate_label)
        self.timecode_frame_rate_combo_box = QtWidgets.QComboBox(self.smpte_timecode_group_box)
        self.timecode_frame_rate_combo_box.setObjectName('timecode_frame_rate_combo_box')
        self.smpte_timecode_layout.addWidget(self.timecode_frame_rate_combo_box)
        self.timecode_sample_rate_label = QtWidgets.QLabel(self.smpte_timecode_group_box)
        self.timecode_sample_rate_label.setObjectName('timecode_sample_rate_label')
        self.smpte_timecode_layout.addWidget(self.timecode_sample_rate_label)
        self.timecode_sample_rate_combo_box = QtWidgets.QComboBox(self.smpte_timecode_group_box)
        self.timecode_sample_rate_combo_box.setObjectName('timecode_sample_rate_combo_box')
        self.smpte_timecode_layout.addWidget(self.timecode_sample_rate_combo_box)
        self.timecode_bit_depth_label = QtWidgets.QLabel(self.smpte_timecode_group_box)
        self.timecode_bit_depth_label.setObjectName('timecode_bit_depth_label')
        self.smpte_timecode_layout.addWidget(self.timecode_bit_depth_label)
        self.timecode_bit_depth_combo_box = QtWidgets.QComboBox(self.smpte_timecode_group_box)
        self.timecode_bit_depth_combo_box.setObjectName('timecode_bit_depth_combo_box')
        self.smpte_timecode_layout.addWidget(self.timecode_bit_depth_combo_box)

        self.midi_timecode_group_box = QtWidgets.QGroupBox(self.left_column)
        self.midi_timecode_group_box.setObjectName('midi_timecode_group_box')
        self.midi_timecode_layout = QtWidgets.QVBoxLayout(self.midi_timecode_group_box)
        self.midi_timecode_layout.setObjectName('midi_timecode_layout')
        self.timecode_midi_output_label = QtWidgets.QLabel(self.midi_timecode_group_box)
        self.timecode_midi_output_label.setObjectName('timecode_midi_output_label')
        self.midi_timecode_layout.addWidget(self.timecode_midi_output_label)
        self.timecode_midi_output_combo_box = QtWidgets.QComboBox(self.midi_timecode_group_box)
        self.timecode_midi_output_combo_box.setObjectName('timecode_midi_output_combo_box')
        self.midi_timecode_layout.addWidget(self.timecode_midi_output_combo_box)
        self.timecode_mtc_frame_rate_label = QtWidgets.QLabel(self.midi_timecode_group_box)
        self.timecode_mtc_frame_rate_label.setObjectName('timecode_mtc_frame_rate_label')
        self.midi_timecode_layout.addWidget(self.timecode_mtc_frame_rate_label)
        self.timecode_mtc_frame_rate_combo_box = QtWidgets.QComboBox(self.midi_timecode_group_box)
        self.timecode_mtc_frame_rate_combo_box.setObjectName('timecode_mtc_frame_rate_combo_box')
        self.midi_timecode_layout.addWidget(self.timecode_mtc_frame_rate_combo_box)
        self.timecode_mtc_idle_behavior_label = QtWidgets.QLabel(self.midi_timecode_group_box)
        self.timecode_mtc_idle_behavior_label.setObjectName('timecode_mtc_idle_behavior_label')
        self.midi_timecode_layout.addWidget(self.timecode_mtc_idle_behavior_label)
        self.timecode_mtc_idle_behavior_combo_box = QtWidgets.QComboBox(self.midi_timecode_group_box)
        self.timecode_mtc_idle_behavior_combo_box.setObjectName('timecode_mtc_idle_behavior_combo_box')
        self.midi_timecode_layout.addWidget(self.timecode_mtc_idle_behavior_combo_box)

        self.left_layout.addWidget(self.audio_playback_group_box)
        self.left_layout.addWidget(self.smpte_timecode_group_box)
        self.left_layout.addWidget(self.midi_timecode_group_box)
    ...
    def retranslate_ui(self):
        ...
        """
        self.audio_playback_group_box.setTitle(translate('OpenLP.AudioDevicesTab', 'Audio Playback'))
        self.audio_output_label.setText(translate('OpenLP.AudioDevicesTab', 'Playback Device'))
        self.smpte_timecode_group_box.setTitle(translate('OpenLP.AudioDevicesTab', 'SMPTE Timecode (LTC)'))
        self.timecode_output_label.setText(translate('OpenLP.AudioDevicesTab', 'Output Device'))
        self.timecode_frame_rate_label.setText(translate('OpenLP.AudioDevicesTab', 'Frame Rate'))
        self.timecode_sample_rate_label.setText(translate('OpenLP.AudioDevicesTab', 'Sample Rate'))
        self.timecode_bit_depth_label.setText(translate('OpenLP.AudioDevicesTab', 'Bit Depth'))
        self.midi_timecode_group_box.setTitle(translate('OpenLP.AudioDevicesTab', 'MIDI Timecode (MTC)'))
        self.timecode_midi_output_label.setText(translate('OpenLP.AudioDevicesTab', 'MIDI Output Device'))
        self.timecode_mtc_frame_rate_label.setText(translate('OpenLP.AudioDevicesTab', 'Frame Rate'))
        self.timecode_mtc_idle_behavior_label.setText(translate('OpenLP.AudioDevicesTab', 'Idle Behavior'))
